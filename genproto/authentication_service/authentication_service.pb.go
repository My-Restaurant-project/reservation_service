...
var file_authentication_authentication_service_proto_goTypes = []interface{}{
...
func file_authentication_authentication_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_authentication_authentication_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_authentication_authentication_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_authentication_authentication_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_authentication_authentication_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_authentication_authentication_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_authentication_authentication_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_authentication_authentication_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
